...
public class GradleShortDependency implements Dependency {
  ...
  public GradleShortDependency(String gradleShort, MavenRepository repo) {
    super();
  ...
  private Stream<DependencyNode> resolveImportsAndMap(org.apache.maven.model.Dependency d) {
    ...
    return Stream.of(new DependencyNode(d.getGroupId(), d.getArtifactId(), d.getVersion(), null));
  }
