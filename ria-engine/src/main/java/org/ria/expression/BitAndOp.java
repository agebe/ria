...
public class BitAndOp extends TripleOp {

  public BitAndOp(Expression exp1, Expression exp2) {
    super(exp1, exp2, "&");
  }
  ...
  public Value eval(ScriptContext ctx) {
    ...
    return and(v1, v2, getOp());
  }

  static Value and(Value v1, Value v2, String op) {
