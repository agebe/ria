...
public class BitRightShiftOp extends TripleOp {

  public BitRightShiftOp(Expression exp1, Expression exp2) {
    super(exp1, exp2, ">>");
  }
  ...
  public Value eval(ScriptContext ctx) {
    ...
    return rightShift(v1, v2, getOp());
  }

  static Value rightShift(Value v1, Value v2, String op) {
